...
from sector_scraper_sgx import scrap_function_sg, scrap_null_data_sg, scrap_stock_page, BASE_URL
import json
import os
import pandas as pd
import numpy as np
...
if __name__ == "__main__":
  ...
  if (sys.argv[1] is not None and params in PARAMS_DICT):
    ...
    if (params == "SG"):
      ...
      print(scrap_stock_page(BASE_URL, "569", "569"))
      print(scrap_stock_page(BASE_URL, "594", "594"))
